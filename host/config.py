...
(board_spec.md "Resolved inputs", Session 002):
    ...
    Pt100, 3 channels, ~100 µA CRD, R_ref ≈ 1.00 kΩ,
...
def make_config(
    ...
    Pt100 defaults follow the resolved configuration (≈100 µA, R_ref ≈1.00 kΩ,
    ...
    # R_ref sized to the ADS range, not the RTD: V_ref ≈ 0.39 * full-scale at
    # nominal current; never clips at the S-101T band max 0.21 mA (rev-F).
