...
> **rev-E (2026-07-11)** re-verified every line against live Digi-Key stock and replaced the
> unbuyable / hand-assembly-hostile parts: CRD CDLL5283 (MELF, zero stock) → **LIS J500
> TO-92 2L** (through-hole, footprint change); all 0603 MLCCs → **0805** (Samsung
