...
## Setup
ngspice .noise -> Johnson PSD (V_ref 3.88, V_RTD 1.29 nV/rtHz); BW=10 Hz. T7=1 uV and ADS=5 uV RMS are ASSUMPTIONS (named in run_all.py) - the bench must confirm them.
...
|---|---|---|
| Johnson R_ref (ngspice) | 0.0156 m | physical |
